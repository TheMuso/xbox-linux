...
struct msdos_sb_info {
	unsigned int sec_per_clus;    /* cluster size */
	unsigned char fats, fat_bits; /* number of FATs, FAT bits (16 or 32) */
...
static inline __u32 fat_get_start(const struct msdos_sb_info *sbi,
				const struct msdos_dir_entry *de)
{
	return le32_to_cpu(de->start);
}

static inline void fat_set_start(struct msdos_dir_entry *de, __u32 cluster)
{
